...
Firefox for android also doesn't support downloading files in the background.<br/>
...
The extension uses [ffmpeg.wasm](https://github.com/ffmpegwasm/ffmpeg.wasm), a WebAssembly port of ffmpeg to convert downloaded videos and GIFs.<br/>
